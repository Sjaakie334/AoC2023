...
function p1() {
    ...
    return possibilities.reduce((total, current) => total * current, 1);
}

const part1 = p1(); //example: 288, act: 503424
...
const part2 = p2(); // example: 71530, actual: 

export const d6Result = { part1, part2 }